...
description: Bộ công cụ Product Management cho CTO bao gồm RICE prioritization, phân tích phỏng vấn khách hàng enterprise VN, PRD templates, discovery frameworks cho dự án chuyển đổi số. Sử dụng cho feature prioritization, user research synthesis, requirement documentation, và product strategy cho CDS Platform.
---
...
- **Chu kỳ mua hàng Enterprise VN**: 3-9 tháng (dài hơn thị trường Mỹ/EU)
- **Quan hệ > Tính năng**: Doanh nghiệp VN ưu tiên đối tác tin cậy hơn feature list
- **Decision makers**: CEO/Founder trực tiếp quyết định ở SMB; Board/Committee ở Enterprise
- **Budget cycle**: Thường lập ngân sách Q4 cho năm sau, mua sắm CNTT tập trung Q1-Q2
- **Pain points phổ biến**: Quy trình thủ công, dữ liệu phân tán, thiếu báo cáo real-time

### Áp Dụng Cho CDS Platform
- **12 Modules**: Sales, Trade Marketing, Marketing, CDP, Inventory, Purchasing, Production, HR, Accounting, BI, Integration, Advanced Tech
- **Khách hàng mục tiêu**: SMB (50-200 NV), Mid-market (200-1000 NV), Enterprise (1000+ NV)
- **Vertical focus**: Retail, FMCG, Manufacturing, Services
- **Pricing model**: Module-based + Implementation + Support
...
| Category | Platforms |
|----------|-----------|
| **CRM/Sales** | CDS Platform, Salesforce, HubSpot, Base.vn |
| **Project Management** | Jira, ClickUp, Notion, Lark |
| **Communication** | Slack, Zalo, Microsoft Teams, Lark |
| **Analytics** | Google Analytics, Metabase, Power BI, CDS BI Module |
| **Design** | Figma, Miro |
...
| **Bỏ qua quan hệ** | Tập trung feature mà quên xây dựng trust | Discovery meeting trước, demo sau. Tham khảo ý kiến từ referral |
