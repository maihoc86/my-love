...
description: |
  Product marketing, positioning, GTM strategy cho CDS Platform tại thị trường Việt Nam.
  Bao gồm ICP definition, April Dunford positioning, launch playbooks, competitive battlecards,
  và chiến lược mở rộng thị trường nội địa.
  Sử dụng khi: phát triển positioning, lập kế hoạch launch, tạo messaging, phân tích đối thủ,
  mở rộng thị trường, enable sales team, hoặc khi cần product marketing, GTM, go-to-market.
  Trigger: "positioning", "GTM", "go-to-market", "competitive analysis",
  "market entry", "sales enablement", "product marketing", "messaging",
  "ICP", "launch playbook", "battlecard".
license: MIT
metadata:
  version: 1.1.0
  ...
  target-market: B2B-Enterprise-VN, digital-transformation
---

# Marketing Strategy & Product Marketing

Expert Product Marketing playbook cho doanh nghiệp B2B tại Việt Nam, tối ưu cho CDS Platform với mô hình Sales-Led và Consultative Selling.
...
### 4.3 Chiến Lược Mở Rộng Thị Trường Việt Nam

**Thứ Tự Ưu Tiên Mở Rộng:**

**Phase 1: TP. Hồ Chí Minh** (Tháng 1-6)
- Tại sao: Trung tâm kinh tế lớn nhất, tập trung DN FDI + DN lớn nội địa
- Chiến lược:
  - Xây dựng đội sales tại HCM (3-5 người)
  - Tham gia sự kiện ngành (Vietnam ICT Summit, Digital Transformation Forum)
  - Partnership với các công ty tư vấn, kế toán lớn
  - Tập trung ngành: Sản xuất, Thương mại, F&B
- Budget: 50% marketing spend
- Target: 10-15 khách hàng mới trong 6 tháng

**Phase 2: Hà Nội** (Tháng 4-9)
- Tại sao: Trung tâm hành chính, nhiều DN nhà nước + tập đoàn lớn
- Chiến lược:
  - Mở văn phòng đại diện hoặc partner với agency tại HN
  - Tham gia sự kiện chính phủ về chuyển đổi số
  - Tập trung ngành: Tài chính, Bảo hiểm, Giáo dục, Y tế
  - Tận dụng chính sách hỗ trợ CĐS của Chính phủ
- Budget: 30% marketing spend
- Target: 8-10 khách hàng mới

**Phase 3: Đà Nẵng & Miền Trung** (Tháng 7-12)
- Tại sao: Hub công nghệ mới nổi, chi phí thấp hơn, DN SME nhiều
- Chiến lược:
  - Partner với các hiệp hội DN tại Đà Nẵng
  - Online-first approach (webinar, remote demo)
  - Gói giá ưu đãi cho SME miền Trung
  - Tập trung ngành: Du lịch, Thủy sản, Logistics
- Budget: 15% marketing spend
- Target: 5-8 khách hàng mới

**Phase 4: Các tỉnh công nghiệp** (Tháng 10-18)
- Tại sao: Bình Dương, Đồng Nai, Hải Phòng - nhiều KCN, FDI
- Chiến lược:
  - Partnership với Ban quản lý KCN
  - Tập trung ngành: Sản xuất, Logistics, Xuất nhập khẩu
  - Gói triển khai nhanh cho nhà máy/KCN
- Budget: 5% marketing spend
- Target: 3-5 khách hàng mới

**Checklist Mở Rộng (mỗi thị trường)**:

- [ ] **Đội ngũ**: Sales rep hoặc partner tại địa phương
- [ ] **Case Study**: Ít nhất 1 case study cùng ngành, cùng khu vực
- [ ] **Sự kiện**: Tham gia 2-3 sự kiện ngành/năm tại khu vực
- [ ] **Quan hệ**: Kết nối hiệp hội DN, phòng thương mại
- [ ] **Content**: Blog/video case study cho ngành trọng điểm khu vực
- [ ] **Pricing**: Gói giá phù hợp quy mô DN khu vực

**Phân Bổ Budget Marketing (Năm 1)**:
```
Tổng Budget Marketing: [X] tỷ/năm
...
- Content/thought leader: 20%
- Sales enablement:       15%
- Partner programs:       10%

Expected: 3-5x ROI (pipeline : marketing spend)
```
